			...
			<footer className="page-footer font-small" id="FooterContainer">
				...
				<div id="FooterLinks">
					<a
						...
						href="/en"
						tabIndex={0}
						aria-label="Set the language of Martin Johannes Nilsen's portfolio to english"
					...
					<a
						...
						href="/no"
						tabIndex={0}
						aria-label="Set the language of Martin Johannes Nilsen's portfolio to norwegian"
